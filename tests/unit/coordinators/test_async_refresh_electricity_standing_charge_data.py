...
from custom_components.edf_energy.coordinators.electricity_standing_charges import ElectricityStandingChargeCoordinatorResult, async_refresh_electricity_standing_charges_data
...
async def test_when_account_info_is_none_then_existing_standing_charge_returned():
  ...
  with mock.patch.multiple(EDFEnergyApiClient, async_get_electricity_standing_charge=async_mocked_get_electricity_standing_charge):
