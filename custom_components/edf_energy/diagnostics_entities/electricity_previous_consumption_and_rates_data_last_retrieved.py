...
class EDFEnergyElectricityPreviousConsumptionAndRatesDataLastRetrieved(EDFEnergyElectricitySensor, EDFEnergyBaseDataLastRetrieved):
  ...
  def unique_id(self):
    ...
    return f"edf_energy_electricity_{self._serial_number}_{self._mpan}_previous_consumption_rates_data_last_retrieved"
