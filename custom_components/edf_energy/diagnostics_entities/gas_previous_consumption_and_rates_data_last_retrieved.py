...
class EDFEnergyGasPreviousConsumptionAndRatesDataLastRetrieved(EDFEnergyGasSensor, EDFEnergyBaseDataLastRetrieved):
  ...
  def unique_id(self):
    ...
    return f"edf_energy_gas_{self._serial_number}_{self._mprn}_previous_consumption_rates_data_last_retrieved"
