...
class EDFEnergyElectricityPreviousConsumptionOverrideRates(EDFEnergyElectricitySensor, EventEntity, RestoreEntity):
  ...
  def unique_id(self):
    ...
    return f"edf_energy_electricity_{self._serial_number}_{self._mpan}{self._export_id_addition}_previous_consumption_rates_{self._config[CONFIG_TARIFF_COMPARISON_NAME]}"
