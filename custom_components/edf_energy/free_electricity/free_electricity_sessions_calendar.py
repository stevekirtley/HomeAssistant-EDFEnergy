...
from . import (
  current_free_electricity_session_event,
  get_next_free_electricity_session_event
)
...
class EDFEnergyFreeElectricitySessionsCalendar(EDFEnergyFreeElectricitySensor, CoordinatorEntity, CalendarEntity, RestoreEntity):
  """Calendar for recording free electricity sessions."""
  ...
  def _handle_coordinator_update(self) -> None:
    ...
    if (current_event is not None):
      self._event = CalendarEvent(
        ...
        summary="EDF Energy Free Electricity",
