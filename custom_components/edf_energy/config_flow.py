...
from .const import (
  ...
  CONFIG_MAX_INTELLIGENT_DISPATCH_HISTORY_RETENTION_IN_DAYS,
  CONFIG_MIN_INTELLIGENT_DISPATCH_HISTORY_RETENTION_IN_DAYS,
        ...
        vol.Schema(
            {
                ...
                vol.Required(CONFIG_MAIN_INTELLIGENT_DISPATCH_HISTORY_RETENTION_IN_DAYS, default=CONFIG_DEFAULT_INTELLIGENT_DISPATCH_HISTORY_RETENTION_IN_DAYS): selector.NumberSelector(
                  selector.NumberSelectorConfig(
                      min=CONFIG_MIN_INTELLIGENT_DISPATCH_HISTORY_RETENTION_IN_DAYS,
                      max=CONFIG_MAX_INTELLIGENT_DISPATCH_HISTORY_RETENTION_IN_DAYS,
                      step=1,
